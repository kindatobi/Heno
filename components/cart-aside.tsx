...
//             }
//           }}
//           className="bg-white hover:bg-[#B3B3B3] text-black font-bold p-4 rounded-full cursor-pointer w-full uppercase tracking-wider text-sm transition-all transform hover:scale-105"
//         >
